          ...
          <form>
            ...
            <div className="flex justify-between whitespace-nowrap text-xs sm:text-lg ">
              <p className=" mb-6 ">Dont have an account? 
                <Link to="/sign-up" className=" cursor-pointer text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-1 ">Register</Link>
              </p>
              <p>
                <Link to="/sign-in" className=" cursor-pointer text-blue-600 hover:text-blue-700 transition duration-200 ease-in-out ">Sign in</Link>
              </p>
            </div>
